...
from autoparking_interface.action import MoveCircle  # 自定义的圆周运动接口
...
class MoveCircleActionClient(Node):
    def __init__(self, name):
        ...
        self.publisher_ = self.create_publisher(String, '/test', 10, callback_group = self.group)   # 创建发布者对象（消息类型、话题名、队列长度）
